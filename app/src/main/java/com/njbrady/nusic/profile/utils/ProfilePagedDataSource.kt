...
class ProfilePagedDataSource(private val localStorage: LocalStorage, private val songListType: SongListType, private val exoMiddleMan: ExoMiddleMan) : PagingSource<Int, SongPlayerWrapper>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, SongPlayerWrapper> {
        return try {
            ...
            val pagedResponse = pagedRequest(localStorage, pageToGet, songListType)
